...
public class DireccionGolpeAbajo extends DireccionGolpe {

	public DireccionGolpeAbajo(Jugador jugador, Terreno terreno) {
	...
	public void lanzarGolpe(Posicion posicion) throws CasilleroNoEncontradoException, CasilleroVacioException {
		terreno.obtenerOcupanteTerreno(posicion.retrocederFila()).recibirGolpe(jugador);
	}
}
