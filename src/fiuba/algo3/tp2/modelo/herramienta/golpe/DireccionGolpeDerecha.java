...
public class DireccionGolpeDerecha extends DireccionGolpe {

	public DireccionGolpeDerecha(Jugador jugador, Terreno terreno) {
	...
	public void lanzarGolpe(Posicion posicion) throws CasilleroNoEncontradoException, CasilleroVacioException {
		terreno.obtenerOcupanteTerreno(posicion.avanzarColumna()).recibirGolpe(jugador);
	}
}
