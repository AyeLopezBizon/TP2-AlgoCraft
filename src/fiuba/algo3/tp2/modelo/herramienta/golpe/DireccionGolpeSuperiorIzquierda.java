...
public class DireccionGolpeSuperiorIzquierda extends DireccionGolpe {

	public DireccionGolpeSuperiorIzquierda(Jugador jugador, Terreno terreno) {
	...
	public void lanzarGolpe(Posicion posicion) 
		...
		terreno.obtenerOcupanteTerreno(posicion.retrocederColumna().avanzarFila()).recibirGolpe(jugador);
	}
