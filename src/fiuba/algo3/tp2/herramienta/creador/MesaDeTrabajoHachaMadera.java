...
public class MesaDeTrabajoHachaMadera extends MesaDeTrabajo{
	...
	public MesaDeTrabajoHachaMadera() 
		...
		materiales.ocuparCasillero(new Madera(),new Posicion(new Integer(1), new Integer(1)));
		materiales.ocuparCasillero(new Madera(),new Posicion(new Integer(1), new Integer(2)));
		materiales.ocuparCasillero(new Vacio(),new Posicion(new Integer(1), new Integer(3)));
		materiales.ocuparCasillero(new Madera(),new Posicion(new Integer(2), new Integer(1)));
